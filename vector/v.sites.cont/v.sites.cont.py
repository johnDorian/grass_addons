...
# PURPOSE:      Finds the contributing area and statistics for multiple sitess
#
# COPYRIGHT:
#
...
def get_stats_cont(map_to_query, table_name, cat):
    ##TODO: This could possible be re-written using v.rast.stats - but the below works and does the same job.
